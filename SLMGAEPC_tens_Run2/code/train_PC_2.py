...
# Mia screening
carpetaInput = '../PC_data_2/'
carpetaOutput = '../resultados_2/3/'
# tensorflow config
...
flags.DEFINE_integer('epochs', 220, 'Number of epochs to train.')
...
flags.DEFINE_float('Beta', 2.2, 'Coefficient of final loss.')
